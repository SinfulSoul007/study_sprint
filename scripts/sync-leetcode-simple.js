...
async function syncProblemsSimple() {
  console.log('🚀 Starting simplified LeetCode problems sync...')
  ...
  try {
    ...
    // Transform the data to match our CURRENT schema
    const transformedProblems = problemsData.map(item => {
      ...
      return {
        ...
        solution_link: `https://leetcode.com/problems/${question.titleSlug}/solutions/`,
        tags: tags,
...
if (require.main === module) {
  syncProblemsSimple()
    .then(() => {
      console.log('✅ Simplified LeetCode problems sync completed successfully!')
      process.exit(0)
    })
    .catch((error) => {
...
module.exports = { syncProblemsSimple } 